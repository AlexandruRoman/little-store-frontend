...
export default class Element extends Component<Props, State> {
    ...
    submit = () => {
        ...
        this.props.pressButton('SEND_REGISTER')
    }

    render() {
        return (
            <BasicModal id={MODALS_IDS.SIGNUP}>
                <div className="popup-align">
                    <h3 className="h3 text-center">register</h3>
                    <div className="empty-space col-xs-b30"></div>
                    <input className="simple-input" type="text" value={this.state.name} onChange={e => this.setState({ name: e.target.value })} placeholder="Your name" />
                    ...
                    <div className="empty-space col-xs-b10 col-sm-b20"></div>
                    <input className="simple-input" type="password" placeholder="Repeat password" />
                    <div className="empty-space col-xs-b10 col-sm-b20"></div>
                    <div className="row">
